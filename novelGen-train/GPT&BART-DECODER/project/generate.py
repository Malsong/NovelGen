...
def main():
    ...
    parser.add_argument('--model_config', default='/content/drive/MyDrive/test-gpt/project/model_save/final_model/config.json', type=str, required=False,
                        help='模型参数')
    parser.add_argument('--tokenizer_path', default='/content/drive/MyDrive/newTrain/gpt2-common/vocab.txt', type=str, required=False, help='词表路径')
    parser.add_argument('--model_path', default='/content/drive/MyDrive/test/project/model_save/final_model', type=str, required=False, help='模型路径')
    parser.add_argument('--prefix', default='我说', type=str, required=False, help='生成文章的开头')
    ...
    for i in range(nsamples):
      with open(args.save_samples_path + '/txt{}.txt'.format(i+1), 'w') as f:
        f.write(textList[i])
